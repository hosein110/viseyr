...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "هیچ داده ای در جدول موجود نیست" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"oAria": {
				 ...
				 *    } );
				 */
				"sSortAscending": ": فعالسازی برای مرتب سازی صعودی ستون",
				 ...
				 *    } );
				 */
				"sSortDescending": ": فعالسازی برای مرتب سازی نزولی"
			},
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "نمایش برگه _PAGE_ از _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			 ...
			 *  @type string
			 *  @default نمایش 0 تا 0 از 0 ورودی
			 *
			 *  @dtopt Language
			 ...
			 *    } );
			 */
			"sInfoFiltered": "(فیلترشده از _MAX_ ورودی)",
