...
return [
    ...
    */
    'attributes' => [
        ...
        'price_payment'         =>'رقم پرداخت شده',
        'username_cpanel'       =>'نام کاربری هاست',
        'password_cpanel'       =>'رمز عبور هاست',
        'username_web'          =>'نام کاربری سایت',
        'password_web'          =>'رمز عبور سایت',
        'type_contract'         =>'نوع قرارداد',
        'condition_payment'     =>'وضعیت پرداخت',
        'domain'                =>'دامنه',
        'price'                 =>'قیمت',
        'category'              =>'دسته بندی',
        'state'                 =>'استان',
        'transport'             =>'حمل و نقل',
        'pastime'               =>'امکانات تفریحی'
    ],
]
